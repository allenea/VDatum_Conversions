...
# =============================================================================
writer = pd.ExcelWriter('NWM_TWL_Forecast_Locations_SciEval-May3.xlsx', engine='xlsxwriter')
...
# =============================================================================
master_list_start = pd.read_excel(os.path.join(path, "Obs Location Requests All.xlsx"),\
                                                                                  header=0)
